...
/********************************************************************************************/
static Fl_Window *fnt_chooser_win;
...
{
	fnt_chooser_win = new Fl_Window(380, 420, "Font Selector");
...
{
	int l;
#warning - this test assumes the file is stored with a Latin-1 encoding...
// If this file is saved as a UTF-8 file, this test does not work any more!
// A better solution might be to store the specific latin-1 byte values here...
...
//	l = fl_latin12utf((const unsigned char*)latin1, strlen(latin1), utf8);
  ...
  Fl::set_font(extra_font,
	...
	main_win = new Fl_Window (200 + 5*75, 400, "Unicode Display Test");
	main_win->begin();
